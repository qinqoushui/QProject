...
public class PmProjLic extends DataEntity<PmProjLic> {
    ...
    private String pmProjLicModuleIdList = "";
    ...
    public String getPmProjLicModuleIdList() {
        return pmProjLicModuleIdList;
    }

    public void setPmProjLicModuleIdList(String pmProjLicModuleIdList) {
        this.pmProjLicModuleIdList = pmProjLicModuleIdList;
    }
}